...
const baseFilters = ["since", "caller_id", "caller_user", "project", "environment", "requested_model", "resolved_group", "provider", "model", "dialect", "client"];
...
export const reportMetadataById = {
  ...
  "provider-catalog-status": meta("provider-catalog-status", {
    shortDescription: "Shows safe provider catalog and active-target metadata.",
    purpose: "Use it to review active/catalog-only status, pricing, modalities, tools, and validation freshness.",
...
const columnDescriptions: Record<string, string> = {
  ...
  model: "Selected upstream model label.",
  dialect: "Upstream API dialect or router skin.",
  status: "Caller-visible terminal HTTP status.",
