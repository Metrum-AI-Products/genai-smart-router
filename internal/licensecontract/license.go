...
// Package licensecontract contains persistence-free license DTOs shared by the
// serving router, license tooling, and Fleet inventory. It has no dependency on
