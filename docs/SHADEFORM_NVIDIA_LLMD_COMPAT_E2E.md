...
This run validates Metrum Smart Router against an in-cluster **llm-d v0.9+** standalone
OpenAI-compatible frontend. Metrum Smart Router does **not** install or control llm-d;
...
Do not add a Metrum Smart Router controller for llm-d.
...
- Uninstall Metrum Smart Router Helm release
