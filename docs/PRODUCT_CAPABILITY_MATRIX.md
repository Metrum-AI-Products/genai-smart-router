...
| Metrum customer control plane / commercial fulfillment | Out of public tree | Payment and commercial fulfillment are out of band. Enterprise keeps signed licenses and external finance; the router must not become a billing ledger, card-processing surface, or holder of private signing keys. |
