...
| How do we handle bursts? | Set caller/project RPM, TPM, concurrency, and budget limits that match the client workload. | Controlled burst test plus quota/report review. | Caller policy review. |
