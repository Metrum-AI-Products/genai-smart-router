...
def main() -> int:
  ...
  with tempfile.TemporaryDirectory() as raw:
    ...
    logs=root/"logs"; base=os.environ|{"PATH":str(bin_dir),"CAPTURE":str(capture),"EVAL_MODEL":"team/coding","EVAL_MODEL_KIND":"router-group","EVAL_API":"openai","EVAL_REASONING":"low","EVAL_BASE_URL":"https://router.invalid/v1","EVAL_API_KEY":"not-a-real-secret","EVAL_LOG_DIR":str(logs),"EVAL_POLICY":str(policy),"EVAL_LIMIT":"2","EVAL_CONCURRENCY":"1"}
    ...
    empty_baseline=base|{"EVAL_BASELINE_JSON":"{}"}
