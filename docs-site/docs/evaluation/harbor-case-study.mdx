...
The model group names shown here are deployment examples from a Metrum-branded reference environment. GenAI Smart Router does not require names such as `big-coder`, and customer deployments can expose different model groups, providers, and policies.
