...
7. Choose the commercial path that fits the deployment: annual enterprise self-hosted, private managed, marketplace/private-offer, renewal, top-up, or other contracted terms as agreed in the commercial plan.
