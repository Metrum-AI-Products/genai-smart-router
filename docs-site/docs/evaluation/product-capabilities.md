...
This page summarizes Metrum Smart Router capabilities for enterprise deployments.
...
Metrum Smart Router is designed as the governed smart-routing layer for enterprise GenAI traffic. Gateway functions underneath routing keep credentials, quotas, and evidence enforceable. It works well when a platform team wants to:
...
Metrum Smart Router can be deployed:
