...
For a repository-local setup, put only placeholder values in shared docs and keep real local settings out of version control:
...
```md title=".claude/agents/router-docs-reviewer.md"
---
