...
Codex CLI supports image attachments with `--image`. The router receives those as OpenAI Responses image inputs and filters to vision-capable upstream targets.
