...
[Evaluate GenAI Smart Router](/docs/evaluation/evaluate-smart-router) gives a complete technical checklist and proof points to request. Self-serve credit-card signup and instant public API credits are future commercial options unless a specific deployment agreement states otherwise; for hosted evaluations, private-cloud deployments, enterprise licenses, monthly or annual subscriptions, and usage-based commercial terms, contact [contact@metrum.ai](mailto:contact@metrum.ai).
...
| Role | Start here |
|---|---|
| Buyer or evaluator | [Commercial Evaluation Path](/docs/evaluation/commercial-evaluation), [Evaluate GenAI Smart Router](/docs/evaluation/evaluate-smart-router), [Solution Brief](/docs/solution-brief), [Security And Trust](/docs/evaluation/security-and-trust) |
...
| Platform administrator | [Router Configuration](/docs/configuration/router-config), [License-Protected Deployments](/docs/operations/license-protected-deployments), [Key Generation](/docs/operations/key-generation), [Usage Reporting](/docs/operations/usage-reporting), [Deployment Readiness](/docs/evaluation/deployment-readiness) |
