...
Metrum Router separates caller API authentication from browser-admin authentication.
...
WWW-Authenticate: Basic realm="Metrum Router Admin", charset="UTF-8"
```
