...
For choosing between `static`, `failover`, `weighted`, `dynamic_score`, `script`, `external`, and contract-backed policies, see [Routing Strategy Decision Tree](../routing/strategy-decision-tree).
