...
Contact [contact@metrum.ai](mailto:contact@metrum.ai) for the current executed
DPA and Standard Contractual Clauses status. Applicable executed DPA/SCC copies
are available on request before a managed-instance deal closes.
