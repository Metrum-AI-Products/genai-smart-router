...
func render(tables []tableDoc) []byte {
	...
	fmt.Fprintf(&b, "\n")
	fmt.Fprintf(&b, "This section is generated by `rtk make docs-diag-schema` from the router usage and content-capture schema structs. Do not edit this block by hand.\n\n")
