...
func usage() {
	fmt.Fprintln(os.Stderr, `usage: metrum-ai-router-customer-lifecycle <command> [flags]
...
Fleet mutation authority remains metrum-ai-router-fleetctl (#555).`)
}
