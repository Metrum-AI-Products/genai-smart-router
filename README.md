...
big-coder  Temporary code-heavy route: Fireworks DeepSeek-V4-Flash 40%, MiniMax M3 Chat 15%, Kimi K2.7 Code 15%, Crusoe GLM 5.2 15%, OpenAI GPT-5.4 Nano 10%, and MiniMax M3 Responses 5% for ordinary text and OpenAI Chat/Responses traffic where supported; Fireworks Responses Kimi K2.7 Code remains available for Codex/Responses tool traffic, while MiniMax and Kimi Anthropic-compatible targets remain available for Claude Code-style tool traffic.
```
