...
big-coder  Code-heavy route: MiniMax-M3 30%, direct Kimi 23%, Crusoe Nemotron 3 Nano Omni Reasoning 20% text-only, Baseten GPT OSS 120B 18%, Baseten GLM 6%, Baseten Nemotron 2%, OpenAI GPT-5.4 Nano 1% non-tool, plus separately validated tool-only OpenAI Chat/Responses/Anthropic-compatible fallbacks.
```
